...
<div class="container login-container">
    <div class="d-flex justify-content-center">
        <h1 class="semi-bold-600 pb-2" style="border-bottom: 5px solid red;">Kurban Yardımı Girişi</h1>
    </div>
    <div class="row">
           ...
           if(!empty($_SESSION['giris']=="basarisiz")) { ?>
            ...
            <form action="admin/netting/islem.php" method="POST">
                <div class="form-group">
                    <input type="email" name="yoksul_mail" class="form-control" placeholder="E-Mail adresi" />
                </div>
                <div class="form-group">
                    <input type="password" name="yoksul_password" class="form-control" placeholder="Şİfre" />
                </div>
                <div class="form-group">
                    <input type="submit" name="yoksulGiris" class="btnSubmit" value="Giriş Yap" />
                </div>
                <div class="form-group">
            ...
            <form action="admin/netting/islem.php" method="POST">
                ...
                <div class="row">
                    <div class="col form-group">
                        <input type="text" name="yoksul_ad" class="form-control" placeholder="Ad" />
                    </div>
                    <div class="col form-group">
                        <input type="text" name="yoksul_soyad" class="form-control" placeholder="Soyad" />
                    </div>

                </div>
                <div class="row">
                    <div class="col form-group">
                        <input type="password" name="yoksul_passwordone" class="form-control" placeholder="Şİfre" />
                    </div>
                    <div class="col form-group">
                        <input type="password" name="yoksul_passwordtwo" class="form-control"
                            placeholder="Şİfre tekrar" />
                    </div>
                </div>
                <div class="form-group">
                    <input type="submit" name="yoksulKayit" class="btnSubmit" value="Kayıt Ol" />
                </div>
