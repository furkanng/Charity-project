      ...
      <svg version="1.1" id="cardfront" xmlns="http://www.w3.org/2000/svg" xmlns:xlink="http://www.w3.org/1999/xlink" x="0px" y="0px" viewBox="0 0 750 471" style="enable-background:new 0 0 750 471;" xml:space="preserve">
        <g id="Front">
          ...
          <text transform="matrix(1 0 0 1 60.106 295.0121)" id="svgnumber" class="st2 st3 st4">0123 4567 8910
            1112</text>
          <text transform="matrix(1 0 0 1 54.1064 428.1723)" id="svgname" class="st2 st5 st6">İsim
            Soyisim</text>
    ...
    <div class="back">
      <svg version="1.1" id="cardback" xmlns="http://www.w3.org/2000/svg" xmlns:xlink="http://www.w3.org/1999/xlink" x="0px" y="0px" viewBox="0 0 750 471" style="enable-background:new 0 0 750 471;" xml:space="preserve">
        ...
        <g id="Back">
          ...
          <text transform="matrix(1 0 0 1 59.5073 228.6099)" id="svgnameback" class="st12 st13">İsim Soyisim
          </text>
        </g>
      </svg>
    </div>
...
<div class="form-container m-auto">
  ...
  <div class="field-container">
    <label for="cardnumber">Kart numarası</label><span id="generatecard">rastgele</span>
  ...
  <div class="field-container">
    <label for="expirationdate">Son kullanma tarihi (aa/gg)</label>
  ...
  <!-- <a href="../../admin/netting/islem.php?bagisci_id=<?php echo $bagiscicek['bagisci_id']; ?>&siparisTamamla=ok"><button class="btn btn-outline-secondary mt-3" type="submit">Alışverişi Tamamla</button></a> -->
  ...
  <form action="../../admin/netting/islem.php" method="POST">
    ...
    while ($sepetcek = $sepetsor->fetch(PDO::FETCH_ASSOC)) {
      ...
      $sepet_kategori = $sepetcek['sepet_kategori'];
      $sepet_adet = $sepetcek['sepet_adet'];
      $sepet_ad = $sepetcek['sepet_ad'];
      $sepet_soyad = $sepetcek['sepet_soyad'];
      $sepet_gsm = $sepetcek['sepet_gsm'];
      $sepet_sehir = $sepetcek['sepet_sehir'];
      $sepet_mail = $sepetcek['sepet_mail'];
      $sepet_kg = $sepetcek['sepet_kg'];
      $sepet_oran = $sepetcek['sepet_oran'];
    ...
    ?>
      ...
      <input type="hidden" name="sepet_kategori[]" value="<?php echo $sepetcek['sepet_kategori']; ?>">
      <input type="hidden" name="sepet_adet[]" value="<?php echo $sepetcek['sepet_adet']; ?>">
      <input type="hidden" name="sepet_ad[]" value="<?php echo $sepetcek['sepet_ad']; ?>">
      <input type="hidden" name="sepet_soyad[]" value="<?php echo $sepetcek['sepet_soyad']; ?>">
      <input type="hidden" name="sepet_gsm[]" value="<?php echo $sepetcek['sepet_gsm']; ?>">
      <input type="hidden" name="sepet_sehir[]" value="<?php echo $sepetcek['sepet_sehir']; ?>">
      <input type="hidden" name="sepet_mail[]" value="<?php echo $sepetcek['sepet_mail']; ?>">
      <input type="hidden" name="sepet_kg[]" value="<?php echo $sepetcek['sepet_kg']; ?>">
      <input type="hidden" name="sepet_oran[]" value="<?php echo $sepetcek['sepet_oran']; ?>">
    ...
    <input type="hidden" name="odenecek_tutar" value="<?php echo $odenecek_tutar; ?>">

    <button class="btn btn-outline-secondary mt-3" name="siparisTamamla" type="submit">Alışverişi Tamamla</button>
  ...
  window.onload = function() {
    ...
    name.addEventListener("input", function() {
      if (name.value.length == 0) {
        document.getElementById("svgname").innerHTML = "İsim Soyisim";
        document.getElementById("svgnameback").innerHTML = "İsim Soyisim";
      } else {
