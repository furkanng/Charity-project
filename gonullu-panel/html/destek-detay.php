        ...
        <div class="col-xl">
            <div class="card mb-4">
                <div class="card-body">
                    ...
                    <a href="../../admin/netting/islem.php?destek_id=<?php echo $destekcek['destek_id']; ?>&desteksildetayGonullu=ok"><button type="submit" class="btn btn-danger m-2">Talebi Sil</button></a>
