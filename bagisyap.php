...
<div class="container login-container">
    <div class="d-flex justify-content-center">
        <h1 class="semi-bold-600 pb-2" style="border-bottom: 5px solid red;">Kurban Bağış Girişi</h1>
    </div>
    <div class="row">
        <div class="col-md-6 login-form-1">
           ...
           if(!empty($_SESSION['giris']=="basarisiz")) { ?>
            ...
            if(!empty($_SESSION['cikis']=="basarili")) { ?>

            <div class="p-1 mb-2 bg-danger text-white alert" align="center" role="alert">Çıkış Başarılı!</div>

            <?php  unset($_SESSION['cikis']);
            ...
            <form action="admin/netting/islem.php" method="POST">
                <div class="form-group">
                    <input type="email" name="bagisci_mail" class="form-control" placeholder="E-Mail adresi" />
                </div>
                <div class="form-group">
                    <input type="password" name="bagisci_password" class="form-control" placeholder="Şİfre" />
                </div>
                <div class="form-group">
                    <input type="submit" name="bagisciGiris" class="btnSubmit" value="Giriş Yap" />
                </div>
                <div class="form-group">
            ...
            <form action="admin/netting/islem.php" method="POST">
                ...
                <div class="row">
                    <div class="col form-group">
                        <input type="text" name="bagisci_ad" class="form-control" placeholder="Ad" />
                    </div>
                    <div class="col form-group">
                        <input type="text" name="bagisci_soyad" class="form-control" placeholder="Soyad" />
                    </div>

                </div>
                <div class="row">
                    <div class="col form-group">
                        <input type="password" name="bagisci_passwordone" class="form-control" placeholder="Şİfre" />
                    </div>
                    <div class="col form-group">
                        <input type="password" name="bagisci_passwordtwo" class="form-control"
                            placeholder="Şİfre tekrar" />
                    </div>
                </div>
                <div class="form-group">
                    <input type="submit" name="bagisciKayit" class="btnSubmit" value="Kayıt Ol" />
                </div>
