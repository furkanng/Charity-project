        ...
        <div class="table-responsive text-nowrap">
            <table class="table">
                ...
                <tbody class="table-border-bottom-0">
                    ...
                    $desteksor = $db->prepare("SELECT * FROM destek where bagisci_id=:id");
                        ...
                        <tr>
                            ...
                            <td>
                                <ul class="list-unstyled users-list m-0 avatar-group d-flex align-items-center">
                                    <li data-bs-toggle="tooltip" data-popup="tooltip-custom" data-bs-placement="top" class="avatar avatar-xs pull-up" title="<?php echo $bagiscicek['bagisci_ad'] ?>">
                                    <?php
                                        if (!empty($bagiscicek['bagisci_resim']) > 0) { ?>
                                            <img src="../../<?php echo $bagiscicek['bagisci_resim']; ?>" class="rounded-circle">
                                        <?php } else { ?>
                            ...
                            <td>
                                <a href="../../admin/netting/islem.php?destek_id=<?php echo $destekcek['destek_id']; ?>&desteksiltalep=ok"><button type="button" class="btn btn-sm  btn-outline-danger">Sil</button></a>
                            </td>
                        <?php } ?>
                        </tr>
                </tbody>
