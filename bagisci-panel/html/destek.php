                    ...
                    <form action="../../admin/netting/islem.php" method="POST">
                            ...
                            <div class="col">
                                <div class="mb-3">
                                    ...
                                    <div class="input-group input-group-merge">
                                        ...
                                        <input type="text" class="form-control" required="" id="basic-icon-default-fullname" value="<?php echo $bagiscicek['bagisci_ad']; ?>" name="destek_ad" />
                                    </div>
                                </div>
                            </div>
                            <div class="col">
                                <div class="mb-3">
                                    ...
                                    <div class="input-group input-group-merge">
                                        <span id="basic-icon-default-fullname2" class="input-group-text"><i class="bx bx-user"></i></span>
                                        <input type="text" class="form-control" required="" name="destek_soyad" id="basic-icon-default-fullname" value="<?php echo $bagiscicek['bagisci_soyad']; ?>" />
                                    </div>
                                </div>
                            </div>
                        </div>
                        <div class="mb-3">
                            ...
                            <div class="input-group input-group-merge">
                                ...
                                <input class="form-control" required="" type="email" id="email" name="destek_mail" value="<?php echo $bagiscicek['bagisci_mail']; ?>" required="" />
                            </div>
                        </div>
                        <div class="mb-3">
                            ...
                            <div class="input-group input-group-merge">
                                ...
                                <input type="text" required="" id="phoneNumber" name="destek_gsm" value="<?php echo $bagiscicek['bagisci_gsm']; ?>" class="form-control" />
                            </div>
                        </div>
                        <div class="mb-3">
                        ...
                        <button type="submit" name="destek" class="btn btn-primary">Gönder</button>
                    </form>
                </div>
