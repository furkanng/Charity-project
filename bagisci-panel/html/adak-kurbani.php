...
<div class="container-xxl flex-grow-1 container-p-y">
    <h4 class="fw-bold py-3 mb-4"><span class="text-muted fw-light">Bağış Yap / Bağış Türü /</span> Adak Kurbanı</h4>
            ...
            <div class="card mb-4">
                ...
                <div class="card-body">
                    <form action="../../admin/netting/islem.php" method="POST">
                        ...
                        <button type="submit" name="sepetekleadak" class="btn btn-primary">Sepete Ekle</button>
                    </form>
                </div>
            </div>
        </div>
